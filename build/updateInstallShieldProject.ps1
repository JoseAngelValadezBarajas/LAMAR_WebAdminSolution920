param([string]$project, [string]$version, [string]$buildNumber, [string]$productCode, [string]$setupFile)

$ism = new-object -comobject IswiAuto27.ISWiProject
...
$prodConfig.SetupFileName = "$setupFile" + ($version -replace '[.]', '')  + "Setup"
