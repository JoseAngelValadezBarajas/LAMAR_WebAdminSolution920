// --------------------------------------------------------------------
// <copyright file="AuthorizationElectronicCertificate.cs" company="Ellucian">
...
using WebAdminServices.Controllers.ElectronicCertificate;

namespace WebAdminServices.Authorize
{
    /// <summary>
    /// Authorization Electronic Degree
    /// </summary>
    /// <seealso cref="Microsoft.Owin.Security.OAuth.OAuthAuthorizationServerProvider" />
    public class AuthorizationElectronicCertificate : OAuthAuthorizationServerProvider
    {
        /// <summary>
        ...
        {
            AccountsECController accountsEDController = new AccountsECController();
            IHttpActionResult actionResult = accountsEDController.GetAccountByGuid(Guid.Parse(context.UserName));
