// --------------------------------------------------------------------
// <copyright file="AuthorizationElectronicDegree.cs" company="Ellucian">
...
namespace WebAdminServices.Authorize
{
    ...
    public class AuthorizationElectronicDegree : OAuthAuthorizationServerProvider
    {
        /// <summary>
        ...
        {
            AccountsEDController accountsEDController = new AccountsEDController();
            IHttpActionResult actionResult = accountsEDController.Get(Guid.Parse(context.UserName));
